...
enum __x_ABI_CWindows_CUI_CXaml_CCore_CDirect_CXamlPropertyIndex
    ...
    __x_ABI_CWindows_CUI_CXaml_CCore_CDirect_CXamlPropertyIndex_CalendarView_DisabledForeground = 1742,
    __x_ABI_CWindows_CUI_CXaml_CCore_CDirect_CXamlPropertyIndex_CalendarView_TodayBackground = 1743,
    __x_ABI_CWindows_CUI_CXaml_CCore_CDirect_CXamlPropertyIndex_CalendarView_TodayBlackoutBackground = 1744,
    __x_ABI_CWindows_CUI_CXaml_CCore_CDirect_CXamlPropertyIndex_CalendarView_TodaySelectedInnerBorderBrush = 1747,
    ...
    __x_ABI_CWindows_CUI_CXaml_CCore_CDirect_CXamlPropertyIndex_HandwritingView_IsCommandBarOpen = 2395,
    __x_ABI_CWindows_CUI_CXaml_CCore_CDirect_CXamlPropertyIndex_HandwritingView_IsSwitchToKeyboardEnabled = 2396,
    __x_ABI_CWindows_CUI_CXaml_CCore_CDirect_CXamlPropertyIndex_ListViewItemPresenter_SelectionIndicatorVisualEnabled = 2399,
    __x_ABI_CWindows_CUI_CXaml_CCore_CDirect_CXamlPropertyIndex_ListViewItemPresenter_SelectionIndicatorBrush = 2400,
    __x_ABI_CWindows_CUI_CXaml_CCore_CDirect_CXamlPropertyIndex_ListViewItemPresenter_SelectionIndicatorMode = 2401,
    __x_ABI_CWindows_CUI_CXaml_CCore_CDirect_CXamlPropertyIndex_ListViewItemPresenter_SelectionIndicatorPointerOverBrush = 2402,
    __x_ABI_CWindows_CUI_CXaml_CCore_CDirect_CXamlPropertyIndex_ListViewItemPresenter_SelectionIndicatorPressedBrush = 2403,
    __x_ABI_CWindows_CUI_CXaml_CCore_CDirect_CXamlPropertyIndex_ListViewItemPresenter_SelectedBorderBrush = 2410,
    __x_ABI_CWindows_CUI_CXaml_CCore_CDirect_CXamlPropertyIndex_ListViewItemPresenter_SelectedInnerBorderBrush = 2411,
    __x_ABI_CWindows_CUI_CXaml_CCore_CDirect_CXamlPropertyIndex_ListViewItemPresenter_CheckBoxCornerRadius = 2412,
    __x_ABI_CWindows_CUI_CXaml_CCore_CDirect_CXamlPropertyIndex_ListViewItemPresenter_SelectionIndicatorCornerRadius = 2413,
    __x_ABI_CWindows_CUI_CXaml_CCore_CDirect_CXamlPropertyIndex_ListViewItemPresenter_SelectedDisabledBorderBrush = 2414,
    __x_ABI_CWindows_CUI_CXaml_CCore_CDirect_CXamlPropertyIndex_ListViewItemPresenter_SelectedPressedBorderBrush = 2415,
    __x_ABI_CWindows_CUI_CXaml_CCore_CDirect_CXamlPropertyIndex_ListViewItemPresenter_SelectedDisabledBackground = 2416,
    __x_ABI_CWindows_CUI_CXaml_CCore_CDirect_CXamlPropertyIndex_ListViewItemPresenter_PointerOverBorderBrush = 2417,
    __x_ABI_CWindows_CUI_CXaml_CCore_CDirect_CXamlPropertyIndex_ListViewItemPresenter_CheckBoxPointerOverBrush = 2418,
    __x_ABI_CWindows_CUI_CXaml_CCore_CDirect_CXamlPropertyIndex_ListViewItemPresenter_CheckBoxPressedBrush = 2419,
    __x_ABI_CWindows_CUI_CXaml_CCore_CDirect_CXamlPropertyIndex_ListViewItemPresenter_CheckDisabledBrush = 2420,
    __x_ABI_CWindows_CUI_CXaml_CCore_CDirect_CXamlPropertyIndex_ListViewItemPresenter_CheckPressedBrush = 2421,
    __x_ABI_CWindows_CUI_CXaml_CCore_CDirect_CXamlPropertyIndex_ListViewItemPresenter_CheckBoxBorderBrush = 2422,
    __x_ABI_CWindows_CUI_CXaml_CCore_CDirect_CXamlPropertyIndex_ListViewItemPresenter_CheckBoxDisabledBorderBrush = 2423,
    __x_ABI_CWindows_CUI_CXaml_CCore_CDirect_CXamlPropertyIndex_ListViewItemPresenter_CheckBoxPressedBorderBrush = 2424,
    __x_ABI_CWindows_CUI_CXaml_CCore_CDirect_CXamlPropertyIndex_ListViewItemPresenter_CheckBoxDisabledBrush = 2425,
    __x_ABI_CWindows_CUI_CXaml_CCore_CDirect_CXamlPropertyIndex_ListViewItemPresenter_CheckBoxSelectedBrush = 2426,
    __x_ABI_CWindows_CUI_CXaml_CCore_CDirect_CXamlPropertyIndex_ListViewItemPresenter_CheckBoxSelectedDisabledBrush = 2427,
    __x_ABI_CWindows_CUI_CXaml_CCore_CDirect_CXamlPropertyIndex_ListViewItemPresenter_CheckBoxSelectedPointerOverBrush = 2428,
    __x_ABI_CWindows_CUI_CXaml_CCore_CDirect_CXamlPropertyIndex_ListViewItemPresenter_CheckBoxSelectedPressedBrush = 2429,
    __x_ABI_CWindows_CUI_CXaml_CCore_CDirect_CXamlPropertyIndex_ListViewItemPresenter_CheckBoxPointerOverBorderBrush = 2430,
    __x_ABI_CWindows_CUI_CXaml_CCore_CDirect_CXamlPropertyIndex_ListViewItemPresenter_SelectionIndicatorDisabledBrush = 2431,
    __x_ABI_CWindows_CUI_CXaml_CCore_CDirect_CXamlPropertyIndex_CalendarView_BlackoutBackground = 2432,
    __x_ABI_CWindows_CUI_CXaml_CCore_CDirect_CXamlPropertyIndex_CalendarView_BlackoutStrikethroughBrush = 2433,
    __x_ABI_CWindows_CUI_CXaml_CCore_CDirect_CXamlPropertyIndex_CalendarView_CalendarItemCornerRadius = 2434,
    __x_ABI_CWindows_CUI_CXaml_CCore_CDirect_CXamlPropertyIndex_CalendarView_CalendarItemDisabledBackground = 2435,
    __x_ABI_CWindows_CUI_CXaml_CCore_CDirect_CXamlPropertyIndex_CalendarView_CalendarItemHoverBackground = 2436,
    __x_ABI_CWindows_CUI_CXaml_CCore_CDirect_CXamlPropertyIndex_CalendarView_CalendarItemPressedBackground = 2437,
    __x_ABI_CWindows_CUI_CXaml_CCore_CDirect_CXamlPropertyIndex_CalendarView_DayItemMargin = 2438,
    __x_ABI_CWindows_CUI_CXaml_CCore_CDirect_CXamlPropertyIndex_CalendarView_FirstOfMonthLabelMargin = 2439,
    __x_ABI_CWindows_CUI_CXaml_CCore_CDirect_CXamlPropertyIndex_CalendarView_FirstOfYearDecadeLabelMargin = 2440,
    __x_ABI_CWindows_CUI_CXaml_CCore_CDirect_CXamlPropertyIndex_CalendarView_MonthYearItemMargin = 2441,
    __x_ABI_CWindows_CUI_CXaml_CCore_CDirect_CXamlPropertyIndex_CalendarView_OutOfScopeHoverForeground = 2442,
    __x_ABI_CWindows_CUI_CXaml_CCore_CDirect_CXamlPropertyIndex_CalendarView_OutOfScopePressedForeground = 2443,
    __x_ABI_CWindows_CUI_CXaml_CCore_CDirect_CXamlPropertyIndex_CalendarView_SelectedDisabledBorderBrush = 2444,
    __x_ABI_CWindows_CUI_CXaml_CCore_CDirect_CXamlPropertyIndex_CalendarView_SelectedDisabledForeground = 2445,
    __x_ABI_CWindows_CUI_CXaml_CCore_CDirect_CXamlPropertyIndex_CalendarView_SelectedHoverForeground = 2446,
    __x_ABI_CWindows_CUI_CXaml_CCore_CDirect_CXamlPropertyIndex_CalendarView_SelectedPressedForeground = 2447,
    __x_ABI_CWindows_CUI_CXaml_CCore_CDirect_CXamlPropertyIndex_CalendarView_TodayBlackoutForeground = 2448,
    __x_ABI_CWindows_CUI_CXaml_CCore_CDirect_CXamlPropertyIndex_CalendarView_TodayDisabledBackground = 2449,
    __x_ABI_CWindows_CUI_CXaml_CCore_CDirect_CXamlPropertyIndex_CalendarView_TodayHoverBackground = 2450,
    __x_ABI_CWindows_CUI_CXaml_CCore_CDirect_CXamlPropertyIndex_CalendarView_TodayPressedBackground = 2451,
    __x_ABI_CWindows_CUI_CXaml_CCore_CDirect_CXamlPropertyIndex_Popup_ActualPlacement = 2452,
    __x_ABI_CWindows_CUI_CXaml_CCore_CDirect_CXamlPropertyIndex_Popup_DesiredPlacement = 2453,
    __x_ABI_CWindows_CUI_CXaml_CCore_CDirect_CXamlPropertyIndex_Popup_PlacementTarget = 2454,
    __x_ABI_CWindows_CUI_CXaml_CCore_CDirect_CXamlPropertyIndex_AutomationProperties_AutomationControlType = 2455,
};
